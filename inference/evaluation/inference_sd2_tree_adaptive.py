...
from model.sd2_tree_adaptive.utils import *
from model.sd2_tree_adaptive.choices import *
from model.sd2_tree_adaptive.modeling import *
from transformers import AutoModelForCausalLM, AutoTokenizer, GenerationMixin
from transformers.models.llama.modeling_llama import LlamaForCausalLM, LlamaModel, LlamaSdpaAttention
from model.sd2_tree_adaptive.modeling_llama_kv import LlamaForCausalLM as KVLlamaForCausalLM
from model.sd2_tree_adaptive.kv_cache import initialize_past_key_values
import torch

def sd2_tree_adaptive_forward(inputs, model, tokenizer, max_new_tokens, tree_choices=None, logits_processor=None, temperature=0.0, drafter=None, max_steps=512):
    ...
    for idx in range(max_steps):
        ...
        draft_tokens=torch.cat((draft_tokens,padding.to(draft_tokens.device)),dim=1)
...
if __name__ == "__main__":
    ...
    # LlamaForCausalLM.adjust_submodels_hiddenstates = adjust_submodels_hiddenstates
    ...
    LlamaForCausalLM.intermediate_layers = submodels
    LlamaForCausalLM.intermediate_thresholds = thresholds
    ...
    drafter = LlamaForCausalLM.from_pretrained(
        args.drafter_path,
        torch_dtype=str_to_torch_dtype(args.dtype),
        low_cpu_mem_usage=True,
        device_map="auto"
    ...
    run_eval(
        model=model,
        tokenizer=tokenizer,
        forward_func=sd2_tree_adaptive_forward,
